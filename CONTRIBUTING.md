...
> **Note:** The following installation instructions apply to Node.js projects. For other languages, refer to their specific package manager requirements.
...
> **Note:** This security configuration applies to Node.js projects using pnpm.
...
3. Run security checks locally before submitting:
   ...
   > **Other languages:** Run appropriate security scanning tools for your language/framework.
...
> **Note:** This section applies to all projects. Snyk supports multiple languages (Node.js, Python, Go, Java, etc.).
